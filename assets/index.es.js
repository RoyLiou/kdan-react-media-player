...
var PlayRateButton = function (_Component) {
  inherits(PlayRateButton, _Component);

  function PlayRateButton(props, content) {
    classCallCheck(this, PlayRateButton);

    var _this = possibleConstructorReturn(this, (PlayRateButton.__proto__ || Object.getPrototypeOf(PlayRateButton)).call(this, props, content));

    _this.handleClick = _this.handleClick.bind(_this);
    return _this;
  }

  createClass(PlayRateButton, [{
    key: 'handleClick',
    value: function handleClick() {
    ...
    value: function render() {
      ...
      var displayRate = function displayRate() {
        if (player) {
  ...
  return PlayRateButton;
}(Component);

PlayRateButton.propTypes = propTypes$28;
PlayRateButton.displayName = 'PlayRateButton';
PlayRateButton.defaultProps = defaultProps$9;
...
var AutoPlayButton = function (_Component) {
  inherits(AutoPlayButton, _Component);

  function AutoPlayButton(props, context) {
    classCallCheck(this, AutoPlayButton);

    var _this = possibleConstructorReturn(this, (AutoPlayButton.__proto__ || Object.getPrototypeOf(AutoPlayButton)).call(this, props, context));
  ...
  createClass(AutoPlayButton, [{
    key: 'handleClick',
    value: function handleClick() {
      var isloop = this.state.isloop;

      var videoEle = document.getElementsByClassName('video-react-video')[0];
...
AutoPlayButton.propTypes = propTypes$29;
AutoPlayButton.displayName = 'AutoPlayButton';
AutoPlayButton.defaultProps = defaultProps$10;
...
MenuItem.propTypes = propTypes$32;
...
var PlayRateMenu = function (_Component) {
  inherits(PlayRateMenu, _Component);

  function PlayRateMenu(props, content) {
    classCallCheck(this, PlayRateMenu);

    var _this = possibleConstructorReturn(this, (PlayRateMenu.__proto__ || Object.getPrototypeOf(PlayRateMenu)).call(this, props, content));
  ...
  createClass(PlayRateMenu, [{
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      var _props = this.props,
          showRateMenu = _props.showRateMenu,
          player = _props.player,
          rates = _props.rates;


      if (nextProps.player !== player) {
        var selectedIndex = rates.indexOf(nextProps.player.playbackRate) || 0;
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          showRateMenu = _props3.showRateMenu,
          player = _props3.player,
          rates = _props3.rates;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'li',
            {
              className: classnames('video-react-menu-item', 'video-react-icon-left-mark', 'title'),
...
PlayRateMenu.propTypes = propTypes$30;
PlayRateMenu.displayName = 'PlayRateMenu';
PlayRateMenu.defaultProps = defaultProps$11;
...
var SettingBar = function (_Component) {
  inherits(SettingBar, _Component);

  function SettingBar(props, content) {
    classCallCheck(this, SettingBar);

    var _this = possibleConstructorReturn(this, (SettingBar.__proto__ || Object.getPrototypeOf(SettingBar)).call(this, props, content));
  ...
  createClass(SettingBar, [{
    key: 'handleClick',
    value: function handleClick(isDisplayed) {
      this.setState({
    ...
    key: 'render',
    value: function render() {
      var showRateMenu = this.state.showRateMenu;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(PlayRateButton, _extends({
        ...
        React.createElement(
          ...
          React.createElement(AutoPlayButton, this.props)
        ),
        React.createElement(PlayRateMenu, _extends({
...
SettingBar.propTypes = propTypes$27;
...
var SettingButton = function (_Component) {
  inherits(SettingButton, _Component);

  function SettingButton(props, context) {
    classCallCheck(this, SettingButton);

    var _this = possibleConstructorReturn(this, (SettingButton.__proto__ || Object.getPrototypeOf(SettingButton)).call(this, props, context));
    ...
    value: function render() {
      ...
      return React.createElement(
        PopupButton,
        {
          ...
          onClick: this.handleClick,
          inline: false },
        React.createElement(SettingBar, _extends({
          onFocus: this.handleFocus,
          onBlur: this.handleBlur
        }, this.props))
      );
...
SettingButton.propTypes = propTypes$26;
  ...
  createClass(ControlBar, [{
    ...
    value: function getFullChildren() {
      return [React.createElement(PlayToggle, _extends({}, this.props, {
        ...
        order: 9
      })), React.createElement(SettingButton, _extends({}, this.props, {
        key: 'setting',
        order: 11
      })), React.createElement(FullscreenToggle, _extends({}, this.props, {
        key: 'fullscreen-toggle',
...
MenuButton.propTypes = propTypes$34;
...
PlaybackRateMenuButton.propTypes = propTypes$33;
PlaybackRateMenuButton.defaultProps = defaultProps$12;
